"""
ASTRA TEST SCRIPT - General and Realtime Chat Selector
========================================================

PURPOSE:
This is a command-line test interface for interacting with A.S.T.R.A.
...
WHY IT EXISTS:
- Provides an easy way to test the ASTRA API without building a frontend
...
def print_header():
    print("\n" + "="*60)
    print("🤖 A.S.T.R.A - General & Realtime Chat")
    print("="*60)
    print("\nModes:")
...
def send_message(message, mode):
    """
    Send a message to the appropriate ASTRA endpoint.
    ...
    Returns:
        str: ASTRA's response, or an error message if something went wrong
...
def get_chat_history():
    ...
    Note:
        ...
        - Messages are numbered and clearly labeled as "You" or "Astra"
    """
    if not SESSION_ID:
