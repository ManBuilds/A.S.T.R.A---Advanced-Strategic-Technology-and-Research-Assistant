...
3. We build a system message: ASTRA_SYSTEM_PROMPT + current time + retrieved context.
...
from config import GROQ_API_KEYS, GROQ_MODEL, ASTRA_SYSTEM_PROMPT
...
class GroqService:
    ...
    def get_response(
        ...
        try:
            ...
            system_message = ASTRA_SYSTEM_PROMPT + f"\n\nCurrent time and date: {time_info}"
            if context:
